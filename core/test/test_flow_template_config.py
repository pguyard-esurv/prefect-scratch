...
class TestFlowTemplateConfig:
    ...
    def test_distributed_processing_flow_uses_config_batch_size(self, mock_processor):
        ...
        mock_processor.claim_records_batch_with_retry.assert_called_once_with("test_flow", 150)
        assert result["batch_size"] == 150

    @patch('core.flow_template.processor')
    def test_distributed_processing_flow_overrides_config_batch_size(self, mock_processor):
        ...
        mock_processor.claim_records_batch_with_retry.assert_called_once_with("test_flow", 50)
    ...
    @patch('core.flow_template.processor')
    def test_flow_template_module_level_config_initialization(self, mock_processor, mock_config_manager):
    ...
    @patch('core.flow_template.processor')
    def test_distributed_processing_flow_with_different_config_values(self, mock_processor):
        ...
        for config in test_cases:
            ...
            mock_processor.claim_records_batch_with_retry.assert_called_with("test_flow", expected_batch_size)
    ...
    def test_flow_template_logging_includes_config_info(self, mock_processor):
        ...
        with patch('core.flow_template.get_run_logger') as mock_get_logger:
            ...
            batch_size_log = next((log for log in log_calls if "batch_size: 75" in log), None)
