...
class TestRPA1IntegrationWithFakeData:
    ...
    def test_rpa1_workflow_with_controlled_fake_data(self):
        ...
        with patch("flows.rpa1.workflow.create_sample_data") as mock_create_data:
            ...
            assert "Premium Widget A" in product_breakdown, (
                "Should have Premium Widget A in breakdown"
            )
            ...
            # Standard Widget B
            assert "Standard Widget B" in product_breakdown, (
                "Should have Standard Widget B in breakdown"
            )
            ...
            # Budget Widget C
            assert "Budget Widget C" in product_breakdown, (
                "Should have Budget Widget C in breakdown"
            )
    ...
    def test_rpa1_workflow_cleanup_behavior(self):
        ...
        with patch("flows.rpa1.workflow.create_sample_data") as mock_create_data:
            ...
            assert (
                result_with_cleanup["total_records"]
                == result_without_cleanup["total_records"]
            )
